...
{
    string CreateEquipIdOnt(int olt, int lt, int pon, int nextAvailOnt, string town);
    string CreateEquipIdFdh(string fdh, string splitterCard, int splitterTail, string town);
